...
import (
	...
	s3repoImpl "mainHashService/internal/repo/s3/impl"
	checkerUc "mainHashService/internal/usecase/checker"
	unhasherUc "mainHashService/internal/usecase/unhasher"
...
func New(cfg *entity.Config) *App {
	...
	return &App{
		Logger:     *lg,
		CheckerUC:  *checkerUc.New(lg, cfg.Endpoint, cfg.HMACSecert),
		UnhasherUC: *unhasherUc.New(lg, cfg.Endpoint, fetchRepo, s3repo, *fileWriter, *zipper),
		HTTP:       cfg.HTTP,
	}
}
