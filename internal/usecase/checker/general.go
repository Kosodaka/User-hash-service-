...
func New(lg *logger.Logger, secretKey string, unhashEndpoint string) *CheckerUCImpl {
...
var _ usecase.CheckerUC = (*CheckerUCImpl)(nil)

// CheckHash - отправляет запрос в другой сервис для того, чтобы проверить,
// правильно ли пользователь вытащил данные из бд.
func (r *CheckerUCImpl) CheckHash(ctx context.Context, hash entity.Checker) (bool, error) {
