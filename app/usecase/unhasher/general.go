...
func New(lg *logger.Logger, unhasherRepo UnhasherRepo, fetchRepo FetchRepo, s3Repo S3Repo, fileWriter writer.FileWriter, fileZipper zipper.Zipper) *UnhasherUCImpl {
